...
export const seedNationalities = async (dataSource: DataSource) => {
    const nationalityRepository = dataSource.getRepository(Nationality);
    await nationalityRepository.upsert(nationalitySeed, { conflictPaths: ['code']});
};
export default seedNationalities;